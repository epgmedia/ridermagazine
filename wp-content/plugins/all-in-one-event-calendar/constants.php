...
function ai1ec_initiate_constants() {
	...
	if ( ! defined( 'AI1EC_VERSION' ) ) {
		define( 'AI1EC_VERSION',            '1.11.4-pro' );
	}
	...
	if ( ! defined( 'AI1EC_THEMES_VERSION' ) ) {
		define( 'AI1EC_THEMES_VERSION',     '31-pro' );
	}
	...
	if ( ! defined( 'AI1EC_TIMELY_SUBSCRIPTION' ) ) {
		define( 'AI1EC_TIMELY_SUBSCRIPTION', 'VElNRUxZLTMwMjY=' );
	}

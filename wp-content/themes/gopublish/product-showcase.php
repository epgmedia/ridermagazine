...
if (get_theme_mod('product-content')=="Display") { ?>
    ...
    <?php } ?>
                    ...
                    <div id="newsticker-demops1" style="width:160px">
                        ...
                        ?>
                                        <p class="homeheadline">
                                            <?php if ($link) echo '<a target="_blank" href="' . $link . $click .'">'; the_title(); if ($link) echo '</a>'; ?>
                                        </p>
    		...
    		<div class="homefeaturedright">
                ...
                <div <?php if ($customcolors==on) { ?>style="background-color:<?php echo $instance['header-color']; ?> !important;"<?php } ?>class="widgetfooter<?php if ($instance['widget-style']=="Style 3") { ?>3<?php } else { ?>1<?php } ?>">

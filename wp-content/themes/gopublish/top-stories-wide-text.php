            ...
            if (have_posts()) : while (have_posts()) : the_post();
                ...
                <div class="cycle">
                    ...
                    if (
                        ...
                        $pattern = "/width=\"[0-9]*\"/";
                        $video = preg_replace($pattern, "width='608'", $video);
                        ?>
                    ...
                    <?php if (get_theme_mod('top-stories-hide-cat')=="No") { ?>
                        ...
                        <p style="margin-bottom:0px">
                            <a href="<?php echo cat_id_to_slug(get_theme_mod('featured-cat')); ?>"
                               class="sectionhead" style="font-size:16px">
                                <?php echo cat_id_to_name(get_theme_mod('featured-cat')); ?>
                                <span class="arrows" style="font-size:24px"> &raquo;&raquo;</span>
                            </a>
                        </p>
                    ...
                    <?php } ?>
					    ...
					    <?php
                        $writercheck=get_post_meta($post->ID, writer, true);

                        if ($writercheck) { ?>

                            <p class="writer" style="font-size:12px;line-height:20px;">
                                <?php snowriter(); ?>
                            </p>
                        ...
                        if (get_theme_mod('top-stories-hide-date')=="No") { ?>
                            ...
                            <p class="datetime" style="font-size:12px;padding-bottom:6px;line-height:12px;">
                                <?php the_time('F j, Y'); ?>
                            </p>

					    <?php }

                        $contentteaser = get_theme_mod('top-stories-teaser');

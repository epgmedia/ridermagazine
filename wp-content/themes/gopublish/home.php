...
<div id="homepage">
    ...
    if (
        (get_theme_mod('top-stories-wide')=="Style 2")
        && (get_theme_mod('top-stories-scrollbox')=="Display")
    ) {
        include(TEMPLATEPATH . "/top-stories-wide.php");
    }

    if (
        (get_theme_mod('top-stories-wide')=="Style 3")
        && (get_theme_mod('top-stories-scrollbox')=="Display")
    ) {
        include(TEMPLATEPATH . "/top-stories-wide-text.php");
    }
	...
	<div id="hpleft">
        ...
        if (
            get_theme_mod('top-stories-scrollbox') == "Display"
            && get_theme_mod('top-stories-wide') == "Style 1"
        ) {
            include(TEMPLATEPATH . "/top-stories-scrollbox.php");
        }
        ?>
		...
		<div class="homepagemaincolumn">
    		...
    		<div id="homepagewide">
	    		<?php
                include(TEMPLATEPATH . "/featured-content.php");
                include(TEMPLATEPATH . "/product-showcase.php");
            ...
            if (
                (get_theme_mod('sno-layout') == "Option 2") || (get_theme_mod('sno-layout') == "Option 5")
            ) { ?>
            ...
            if (
                (get_theme_mod('sno-layout') == "Option 1") || (get_theme_mod('sno-layout') == "Option 4")
            ) { ?>

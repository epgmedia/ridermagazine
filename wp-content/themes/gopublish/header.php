...
<head profile="http://gmpg.org/xfn/11">
    ...
    googletag.defineSlot('/35190362/RDR_ROS_160_SB1', [[120, 240], [125, 125], [120, 600], [160, 160], [160, 240], [160, 600]], 'div-gpt-ad-1375711686389-0').addService(googletag.pubads());
    googletag.defineSlot('/35190362/RDR_ROS_160_SB2', [[120, 240], [125, 125], [120, 600], [160, 160], [160, 240], [160, 600]], 'div-gpt-ad-1375711686389-1').addService(googletag.pubads());
    googletag.defineSlot('/35190362/RDR_ROS_160_SB3', [[120, 240], [125, 125], [120, 600], [160, 160], [160, 240], [160, 600]], 'div-gpt-ad-1375711686389-2').addService(googletag.pubads());
    googletag.defineSlot('/35190362/RDR_ROS_160_SB4', [[120, 240], [125, 125], [120, 600], [160, 160], [160, 240], [160, 600]], 'div-gpt-ad-1375711686389-3').addService(googletag.pubads());
    googletag.defineSlot('/35190362/RDR_ROS_160_SB5', [[120, 240], [125, 125], [120, 600], [160, 160], [160, 240], [160, 600]], 'div-gpt-ad-1375711686389-4').addService(googletag.pubads());
    googletag.defineSlot('/35190362/RDR_ROS_160_SB6', [[120, 240], [125, 125], [120, 600], [160, 160], [160, 240], [160, 600]], 'div-gpt-ad-1375711686389-5').addService(googletag.pubads());
    googletag.defineSlot('/35190362/RDR_ROS_160_SB7', [[120, 240], [125, 125], [120, 600], [160, 160], [160, 240], [160, 600]], 'div-gpt-ad-1375711686389-6').addService(googletag.pubads());
    ...
    googletag.defineSlot('/35190362/RDR_ROS_middle468_2', [468, 60], 'div-gpt-ad-1375711686389-14').addService(googletag.pubads());
...
<body>
    ...
    <?php
    if (get_theme_mod('leaderboard-location') == "Above Header") include(TEMPLATEPATH . "/leaderboardhead.php");
    ?>
        ...
        <div id="header">
            ...
            <?php if(get_theme_mod('header_blog_title') == 'Image') { ?>
                ...
                <a href="<?php echo get_settings('home'); ?>/">
                    <img src="<?php echo get_theme_mod('header-image'); ?>" style="width:<?php echo get_theme_mod('header-width'); ?>px;height:<?php echo get_theme_mod('header-height'); ?>px" alt="<?php bloginfo('description'); ?>" />
                </a>
            ...
            <?php } else if(get_theme_mod('header_blog_title')=='SubscribeAd') { ?>
                ...
                <div id="subscribeButton">
                    <a href="<?php echo get_theme_mod('subscribe-link'); ?>">
                        <img src="<?php echo get_theme_mod('subscribe-image'); ?>" alt="Subscribe Today" style="width:<?php echo get_theme_mod('subscribe-width'); ?>px;height:<?php echo get_theme_mod('subscribe-height'); ?>px;" />
                    </a>
                </div>

...
<div id="header">
  ...
  <div id="headerleft" <?php if(get_theme_mod('header_blog_title') == 'Image') { ?>style="padding-left:0px;width:960px;" <?php } ?>>
    ...
    <?php } else if(get_theme_mod('header_blog_title')=='SubscribeAd') { ?>
	            ...
	            <div id="subscribeHeader"><a href="<?php echo get_settings('home'); ?>/"><img src="<?php echo get_theme_mod('header-image'); ?>" style="width:<?php echo get_theme_mod('header-width'); ?>px;height:<?php echo get_theme_mod('header-height'); ?>px" alt="<?php bloginfo('description'); ?>" /></a></div><div id="subscribeButton"><a href="<?php echo get_theme_mod('subscribe-link'); ?>"><img src="<?php echo get_theme_mod('subscribe-image'); ?>" alt="Subscribe Today" style="width:<?php echo get_theme_mod('subscribe-width'); ?>px;height:<?php echo get_theme_mod('subscribe-height'); ?>px;" /></a></div>

...
// Don't need to run anything if Instance isn't set.
if ( isset( $instance['widget-style'] ) ) :
...
if ( $instance['widget-style'] == "Style 1" ) { ?>
	...
	<h4 class="widget1" <?php if ($customcolors == 'on') { ?>style="
		...
		<?php if ( isset($categoryslug) ) { ?>
			<a <?php if ($customcolors == 'on') { ?>style="color: <?php echo $instance['header-text']; ?> !important;"<?php } ?>
			   href="<?php echo $categoryslug; ?>">
				<?php if ( isset($videotitle) ) {
					echo $videotitle;
				} else {
					echo $categoryname;
				} ?>
...
<?php } else if ( $instance['widget-style'] == "Style 4" ) {
	...
	<?php } ?>
		">
		<h4 class="widget4"
		    <?php if ($customcolors == 'on') { ?>style="background-color: <?php echo $instance['header-color']; ?> !important; color: <?php echo $instance['header-text']; ?> !important;"<?php } ?>>
			<?php if (isset( $categoryslug ) ) { ?>
				<a <?php if ($customcolors == 'on') { ?>style="color: <?php echo $instance['header-text']; ?> !important;"<?php } ?>
				   href="<?php echo $categoryslug; ?>"><?php if ( isset( $videotitle ) ) {
						echo $videotitle;
					} else {
						echo $categoryname;
					} ?>

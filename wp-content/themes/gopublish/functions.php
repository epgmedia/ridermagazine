...
//start widgetized-page code added by GZ 13Dec2011
if ( function_exists('register_sidebars') )
{
...
//end widgetized-page code added by GZ 13Dec2011
...
function custom_search_where($where) { 
	...
	if (is_search() && isset($_GET['s'])) { 
		...
		$n = ($_GET['exact']) ? '' : '%'; 
		$searchand = ''; foreach((array)$search_terms as $term) { 

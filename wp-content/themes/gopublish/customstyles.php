...
#content h5 { color: #fff; ?> !important; }
...
h4.widget1 { background: <?php echo get_theme_mod('widgetcolor4'); ?> url(<?php bloginfo('template_url'); ?>/images/navbg.png) repeat-x !important; background-color: <?php echo get_theme_mod('widgetcolor1'); ?> !important; color: <?php echo get_theme_mod('widgetcolor1-text'); ?> !important; border-left:<?php echo get_theme_mod('widget1-thickness'); ?> solid <?php echo get_theme_mod('widgetborder1'); ?> !important; border-right:<?php echo get_theme_mod('widget1-thickness'); ?> solid <?php echo get_theme_mod('widgetborder1'); ?> !important; border-top:<?php echo get_theme_mod('widget1-thickness'); ?> solid <?php echo get_theme_mod('widgetborder1'); ?> !important; font-weight:bold !important; padding-left:10px !important; font-size:17px !important;line-height:26px !important;  margin:0px !important;}
...
/* Force styling for Calendar header */
#content h2.ai1ec-calendar-title {

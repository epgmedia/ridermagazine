...
if (isset($email) && isset($id)) {
                 echo '<iframe src="https://www.rv.net/email/preferences/index.cfm?email='.$email.'&id='.$id.'&source=rider%20magazine" scrolling="no" width="510" height="1200" frameborder="0" id="confirmemailframe"></iframe>';
 }
?>
